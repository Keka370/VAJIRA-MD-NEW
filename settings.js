...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? 'VAJIRA-MD=ucs1XT4Z#gp2KvKWf9vCuaO9PNpgBUPHyF5D6ElKBzKiW3V3oHJI' : process.env.SESSION_ID,
OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '163718036108' : process.env.OWNER_NUMBER,   
...
WORK_TYPE: process.env.WORK_TYPE || 'piblic' ,
